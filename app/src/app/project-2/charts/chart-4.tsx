...
export const description = "Average Taxi-Out Time by Visibility";
...
const chartData: WeatherData[] = [
  { visibility: "Low", taxiOutTime: 44 },
  { visibility: "Medium", taxiOutTime: 38 },
  { visibility: "High", taxiOutTime: 37 },
];
    ...
    <Card className="py-0 rounded-none">
      <CardHeader className="flex flex-col items-stretch border-b !p-0 sm:flex-row">
        <div className="flex flex-1 flex-col justify-center gap-1 px-6 pt-4 pb-3 sm:!py-0">
          <CardTitle>Average Taxi-Out Time by Visibility</CardTitle>
          <CardDescription>
            Taxi-out time in minutes across different visibility categories
          </CardDescription>
        </div>
        <div className="flex">
          ...
          >
            ...
            <ChartTooltip
              content={
                <ChartTooltipContent
                  className="w-[180px]"
                  labelFormatter={(label) => `Visibility: ${label}`}
